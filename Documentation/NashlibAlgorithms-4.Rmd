...
```{r code=xfun::read_utf8('../fortran/a24.f'), echo=TRUE, eval=FALSE}
```
...
The 1990 edition of Compact Numerical Methods included three different examples
of use of conjugate gradients for linear algebraic problems:
