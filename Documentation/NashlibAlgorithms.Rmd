...
../fortran/dr0102.run < ../fortran/dr0102.txt
```
...
../fortran/a3.run < ../fortran/a3data.txt > ../fortran/a3out.txt
```
...
\pagebreak
# Algorithms 14 and 15 - Generalized symmetric eigenproblem
...
# Algorithnms added in the 2nd Edition, 1990.
