...
C  IBM MACHINE PRECISION
      EPS=16.0**(-5)
C Put NOUT for 0 in next line to get intermediate output
      CALL A22CGM(N,B,WFUN,WDER,NOCOM,0,LIMIT,LIMIT2,EPS,G,X,T,C,VL)
