...
def calceps():
    """Returns machine EPSILON or floating point tolerance

    Machine EPSILON is the smallest positive real number such that 1.0 +
    EPSILON > 1.0.  EPSILON is needed to set various tolerances for
    different algorithms. While it could be entered as a constant,
    caculating it is safer lest users accidently port the wrong constant
    between machines without paying attention to the computing
    environment. Note that more complete routines exist.
    """
